		...
		<div class="row-fluid">
			<div class="span3">
				<div class="well sidebar-nav">
					<ul class="nav nav-list">
						...
						<!-- 마우스오버를 사용하여 액션 넣기 -->
						<li><a href="<c:url value='/library/rentbook'/>">도서대여</a></li>
						<li class="active"><a href="<c:url value='/library/returnbook'/>">도서반납</a></li>
					</ul>
				</div>
				<!--/.well -->
			</div>
			...
			<div class="span8">
				...
				<div class="row-fluid">
					<div class="span4">
						<!-- 대여코드 조회 -->
						<form action="<c:url value='/library/bookReturnCheck'/>" method="post">
							<table>
								<tr>
