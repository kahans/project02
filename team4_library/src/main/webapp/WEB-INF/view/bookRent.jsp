...
<body>
			...
			<div class="container-fluid">
				...
				<div class="nav-collapse collapse">
					...
					<ul class="nav">
						...
						<li class="active"><a href="<c:url value='/library/rentBook'/>">대여관리</a></li>
					</ul>
				</div>
				<!--/.nav-collapse -->
			</div>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span3">
				<div class="well sidebar-nav">
					<ul class="nav nav-list">
						...
						<li class="active"><a href="<c:url value='/library/rentbook'/>">도서대여</a></li>
						<li><a href="<c:url value='/library/bookReturnCheck'/>">도서반납</a></li>
					</ul>
				</div>
				<!--/.well -->
			</div>
			...
			<div class="span8">
				<div class="hero-unit">
					<h1 align="center">대여</h1>
				</div>
				<div class="row-fluid">
					<div class="span4">
						<!-- 대여 폼 -->
						<form action="<c:url value='/library/rentbook'/>" method="post">
							<div>
							...
							<div>
								대여일: <input type="date" name="rDStrat"/>
							</div>
							<div>
								종료일: <input type="date" name="rDEnd" />
							</div>
							<div>
								결제금액: <input type="text" name="rentalPay" />
							</div>
							<!-- <input type="submit" value="대여" />
							<input type="reset"	value="초기화" /> -->
							<input type="submit" class="btn btn-primary btn-large" value="대여" />
